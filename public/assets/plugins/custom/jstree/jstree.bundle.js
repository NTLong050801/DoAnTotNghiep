...
/*jshint -W083 */
	...
	/**
	 * holds all jstree related functions and variables, including the actual class and methods to create.blade.php, access and manipulate instances.
	 * @name $.jstree
	 */
	$.jstree = {
		/**
	 ...
	 * @name $.jstree.create.blade.php(el [, options])
	 * @param {DOMElement|jQuery|String} el the element to create.blade.php the instance on, can be jQuery extended or a selector
	 ...
	 *	$('#tree2').jstree({ plugins : [] }); // create.blade.php an instance with some options
	 *	$('#tree1').jstree('open_node', '#branch_1'); // call a method on an existing instance, passing additional arguments
	 *	$('#tree2').jstree(); // get an existing instance (or create.blade.php an instance)
	 *	$('#tree2').jstree(true); // get an existing instance (will not create.blade.php new instance)
	...
	$.fn.jstree = function (arg) {
		...
		this.each(function () {
			...
			result = is_method && method ?
				...
				null;
			// if there is no instance and no method is being called - create.blade.php one
	...
	$.jstree.defaults.core = {
		 ...
		 * If left as `false` all operations like create.blade.php, rename, delete, move or copy are prevented.
	...
	$.jstree.core.prototype = {
      ...
      if (obj && $.inArray(obj.id, this._model.changed) === -1) {
		...
		/**
		 * create.blade.php a new node (do not confuse with load_node)
		 * @name create_node([par, node, pos, callback, is_loaded])
		 * @param  {mixed}   par       the parent node (to create.blade.php a root node use either "#" (string) or `null`)
		 * @param  {mixed}   node      the data for the new node (a valid JSON object, or a simple string with the name)
		 * @param  {mixed}   pos       the index at which to insert the node, "first" and "last" are also supported, default is "last"
		 * @param  {Function} callback a function to be called once the node is created
		 * @param  {Boolean} is_loaded internal argument indicating if the parent node was succesfully loaded
		 * @return {String}            the ID of the newly create.blade.php node
 ...
 */
	...
	$.jstree.defaults.contextmenu = {
		 ...
		 * * `submenu` - an object with the same structure as $.jstree.defaults.contextmenu.items which can be used to create.blade.php a submenu - each key will be rendered as a separate option in a submenu that will appear once the current item is hovered
		 *
