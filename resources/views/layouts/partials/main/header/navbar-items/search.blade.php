                    ...
                    <div class="position-absolute top-50 end-0 translate-middle-y"
                        ...
                        <div data-kt-search-element="preferences-show"
                            ...
                            <span class="svg-icon svg-icon-1">
                                <img src="{{asset('assets/media/icons/duotune/coding/cod001.svg')}}" alt=""/>
                            </span>
                            <!--end::Svg Icon-->
                        </div>
                            ...
                            <div class="symbol symbol-40px me-4">
                                <span class="symbol-label bg-light">
                                    ...
                                    <span class="svg-icon svg-icon-2 svg-icon-primary">
                                        <img src="{{asset('assets/media/icons/duotune/general/gen005.svg')}}" alt=""/>
                                    </span>
                                    <!--end::Svg Icon-->
                                </span>
                            </div>
                           ...
                           class="d-flex text-dark text-hover-primary align-items-center mb-5">
                            ...
                            <div class="symbol symbol-40px me-4">
                                <span class="symbol-label bg-light">
                                    ...
                                    <span class="svg-icon svg-icon-2 svg-icon-primary">
                                        <img src="{{asset('assets/media/icons/duotune/general/gen032.svg')}}" alt=""/>
                                    </span>
                                    <!--end::Svg Icon-->
                                </span>
                            </div>
                           ...
                           class="d-flex text-dark text-hover-primary align-items-center mb-5">
                            ...
                            <div class="symbol symbol-40px me-4">
                                <span class="symbol-label bg-light">
                                    ...
                                    <span class="svg-icon svg-icon-2 svg-icon-primary">
                                        <img src="{{asset('assets/media/icons/duotune/communication/com006.svg')}}" alt=""/>
                                    </span>
                                    <!--end::Svg Icon-->
                                </span>
                            </div>
                        ...
                        <div class="d-flex align-items-center mb-5">
                            ...
                            <div class="symbol symbol-40px me-4">
                                <span class="symbol-label bg-light">
                                    ...
                                    <span class="svg-icon svg-icon-2 svg-icon-primary">
                                        <img src="{{asset('assets/media/icons/duotune/electronics/elc004.svg')}}" alt=""/>
                                    </span>
                                    <!--end::Svg Icon-->
                                </span>
                            </div>
                        ...
                        <div class="d-flex align-items-center mb-5">
                            ...
                            <div class="symbol symbol-40px me-4">
                                <span class="symbol-label bg-light">
                                    ...
                                    <span class="svg-icon svg-icon-2 svg-icon-primary">
                                        <img src="{{asset('assets/media/icons/duotune/graphs/gra001.svg')}}" alt=""/>
                                    </span>
                                    <!--end::Svg Icon-->
                                </span>
                            </div>
                        ...
                        <div class="d-flex align-items-center mb-5">
                            ...
                            <div class="symbol symbol-40px me-4">
                                <span class="symbol-label bg-light">
                                    ...
                                    <span class="svg-icon svg-icon-2 svg-icon-primary">
                                        <img src="{{asset('assets/media/icons/duotune/graphs/gra006.svg')}}" alt=""/>
                                    </span>
                                    <!--end::Svg Icon-->
                                </span>
                            </div>
                        ...
                        <div class="d-flex align-items-center mb-5">
                            ...
                            <div class="symbol symbol-40px me-4">
                                <span class="symbol-label bg-light">
                                    ...
                                    <span class="svg-icon svg-icon-2 svg-icon-primary">
                                        <img src="{{asset('assets/media/icons/duotune/graphs/gra002.svg')}}" alt=""/>
                                    </span>
                                    <!--end::Svg Icon-->
                                </span>
                            </div>
                        ...
                        <div class="d-flex align-items-center mb-5">
                            ...
                            <div class="symbol symbol-40px me-4">
                                <span class="symbol-label bg-light">
                                    ...
                                    <span class="svg-icon svg-icon-2 svg-icon-primary">
                                        <img src="{{asset('assets/media/icons/duotune/communication/com010.svg')}}" alt=""/>
                                    </span>
                                    <!--end::Svg Icon-->
                                </span>
                            </div>
                ...
                <div data-kt-search-element="empty" class="text-center d-none">
                    ...
                    <div class="pt-10 pb-10">
                        ...
                        <span class="svg-icon svg-icon-4x opacity-50">
                            <img src="{{asset('assets/media/icons/duotune/files/fil024.svg')}}" alt=""/>
                        </span>
                        <!--end::Svg Icon-->
                    </div>
                    <!--end::Icon-->
