                        ...
                        <div class="timeline-icon symbol symbol-circle symbol-40px me-4">
                            <div class="symbol-label bg-light">
                                ...
                                <span class="svg-icon svg-icon-2 svg-icon-gray-500">
                                       <img src="{{asset('assets/media/icons/duotune/communication/com003.svg')}}" alt="">
                                    </span>
                                <!--end::Svg Icon-->
                            </div>
                        </div>
                    ...
                    <div class="timeline-item">
                        ...
                        <div class="timeline-icon symbol symbol-circle symbol-40px">
                            <div class="symbol-label bg-light">
                                ...
                                <span class="svg-icon svg-icon-2 svg-icon-gray-500">
                                     <img src="{{asset('assets/media/icons/duotune/communication/com009.svg')}}" alt="">
                                    </span>
                                <!--end::Svg Icon-->
                            </div>
                        </div>
                    ...
                    <div class="timeline-item">
                        ...
                        <div class="timeline-icon symbol symbol-circle symbol-40px">
                            <div class="symbol-label bg-light">
                                ...
                                <span class="svg-icon svg-icon-2 svg-icon-gray-500">
                                   <img src="{{asset('assets/media/icons/duotune/coding/cod008.svg')}}" alt="">
                                    </span>
                                <!--end::Svg Icon-->
                            </div>
                        </div>
                    ...
                    <div class="timeline-item">
                        ...
                        <div class="timeline-icon symbol symbol-circle symbol-40px">
                            <div class="symbol-label bg-light">
                                ...
                                <span class="svg-icon svg-icon-2 svg-icon-gray-500">
                                  <img src="{{asset('assets/media/icons/duotune/abstract/abs027.svg')}}" alt="">
                                    </span>
                                <!--end::Svg Icon-->
                            </div>
                        </div>
                            ...
                            <div class="overflow-auto pb-5">
                                ...
                                <div
                                    ...
                                    <span class="svg-icon svg-icon-2tx svg-icon-primary me-4">
                                        <img src="{{asset('assets/media/icons/duotune/coding/cod004.svg')}}" alt="">
                                        </span>
                                    <!--end::Svg Icon-->
                                    <!--end::Icon-->
                                    <!--begin::Wrapper-->
                    ...
                    <div class="timeline-item">
                        ...
                        <div class="timeline-icon symbol symbol-circle symbol-40px">
                            <div class="symbol-label bg-light">
                                ...
                                <span class="svg-icon svg-icon-2 svg-icon-gray-500">
                                    <img src="{{asset('assets/media/icons/duotune/ecommerce/ecm002.svg')}}" alt="">
                                    </span>
                                <!--end::Svg Icon-->
                            </div>
                        </div>
