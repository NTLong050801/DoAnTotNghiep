                                    ...
                                    <div class="pt-1">
                                        ...
                                        <div class="d-flex align-items-center mb-7">
                                            ...
                                            <span class="svg-icon svg-icon-1 svg-icon-success">
                                                   <img src="{{asset('assets/media/icons/duotune/general/gen043.svg')}}"
                                                        alt="">
                                                </span>
                                            <!--end::Svg Icon-->
                                        </div>
                                        ...
                                        <div class="d-flex align-items-center mb-7">
                                            ...
                                            <span class="svg-icon svg-icon-1 svg-icon-success">
                                                    <img
                                                        src="{{asset('assets/media/icons/duotune/general/gen043.svg')}}"
                                                        alt="">
                                                </span>
                                            <!--end::Svg Icon-->
                                        </div>
                                        ...
                                        <div class="d-flex align-items-center mb-7">
                                            ...
                                            <span class="svg-icon svg-icon-1">
                                                    <img
                                                        src="{{asset('assets/media/icons/duotune/general/gen040.svg')}}"
                                                        alt="">
                                                </span>
                                            <!--end::Svg Icon-->
                                        </div>
