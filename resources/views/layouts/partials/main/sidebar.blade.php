                ...
                <div class="menu-block">
                    ...
                    <div class="menu-item">
                        ...
                        <a class="menu-link" href="#">
                            ...
                            <span class="menu-title">Thông báo hệ thống</span>
                        </a>
                        <!--end:Menu link-->
                    </div>
                </div>
                ...
                <div class="menu-block">
                    ...
                    <div class="menu-item">
                        ...
                        <a class="menu-link" href="#">
                            ...
                            <span class="menu-title">Hồ sơ Nội</span>
                        </a>
                        <!--end:Menu link-->
                    </div>
                    <!--end:Menu item-->
                    ...
                    <div class="menu-item">
                        <!--begin:Menu link-->
                        <a class="menu-link" href="#">
                            <span class="menu-icon"><i class="fa-solid fa-earth-asia"></i></span>
                            <span class="menu-title">Hồ sơ Ngoại</span>
                        </a>
                        <!--end:Menu link-->
                    </div>
                    <!--end:Menu item-->
                    ...
                    <div class="menu-item">
                        ...
                        <a class="menu-link" href="#">
                            ...
                            <span class="menu-title">Cán bộ Tuyển dụng</span>
                        </a>
                        <!--end:Menu link-->
                    </div>
                    <!--end:Menu item-->
                ...
                <div class="menu-block">
                    ...
                    <div class="menu-item">
                        ...
                        <a class="menu-link" href="#">
                            ...
                            <span class="menu-title">Thiết lập hệ thống</span>
                        </a>
                        <!--end:Menu link-->
                    </div>
                    <!--end:Menu item-->
