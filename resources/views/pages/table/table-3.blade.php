                ...
                <tr>
                    <td>
                        <div class="d-flex align-items-center">
                            ...
                            <div class="d-flex justify-content-start flex-column">
                                <a href="#" class="text-dark fw-bold text-hover-primary mb-1 fs-6">Sant Extreanet
                                    Solution</a>
                    ...
                    <td class="text-end">
                        ...
                        <a href="#" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
                            ...
                            <span class="svg-icon svg-icon-3">
                                <img src="{{asset('assets/media/icons/duotune/general/gen027.svg')}}" alt=""></span>
                            <!--end::Svg Icon-->
                        </a>
                    </td>
                </tr>
                <tr>
                    <td>
                        <div class="d-flex align-items-center">
                            ...
                            <div class="d-flex justify-content-start flex-column">
                                <a href="#" class="text-dark fw-bold text-hover-primary mb-1 fs-6">Telegram
                                    Development</a>
                ...
                <tr>
                    <td>
                        <div class="d-flex align-items-center">
                            ...
                            <div class="d-flex justify-content-start flex-column">
                                <a href="#" class="text-dark fw-bold text-hover-primary mb-1 fs-6">Payroll
                                    Application</a>
                ...
                <tr>
                    <td>
                        <div class="d-flex align-items-center">
                            ...
                            <div class="d-flex justify-content-start flex-column">
                                <a href="#" class="text-dark fw-bold text-hover-primary mb-1 fs-6">HR Management
                                    System</a>
                                <span
                                    class="text-muted fw-semibold text-muted d-block fs-7">Python, PostgreSQL, ReactJS
                                </span>
                            </div>
                        </div>
                    </td>
