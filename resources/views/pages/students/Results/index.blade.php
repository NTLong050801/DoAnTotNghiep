            ...
            <div class="card-title">
                ...
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <input type="text" data-kt-customer-table-filter="search"
                           class="form-control form-control-solid w-250px ps-15" placeholder="Tên bài thi">
                </div>
                <!--end::Search-->
            </div>
            <!--begin::Card title-->
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer"
                        ...
                        @foreach($examStudents as $examStudent)
                            <tr class="odd">
                                ...
                                <td class="text-danger fs-2">{{(float)$examStudent->result*10/count(json_decode($examStudent->questions))}}</td>
                                <!--begin::Action=-->
                                <td class="text-end">
